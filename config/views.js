...
twig.extend(function(Twig) {
    ...
    Twig.exports.extendFilter('kwadrat', function(num) {
        return num * num;
    });

    Twig.exports.extendFunction('kwadrat', function(num) {
        return num * num;
    });

    Twig.exports.extendFunction('getAsset', function(asset, withProtocol) {
        var protocol = 'http',
            url = '';

        if(asset) {
            url = protocol + '://' + sails.config.root + asset + '?v=' + sails.config.assetsVersion;
        }
  ...
  ****************************************************************************/
  ...
  engine: {
    ...
    fn: function(pathName, locals, cb) {
      return twig.renderFile(pathName, locals, cb);
    }
  },
